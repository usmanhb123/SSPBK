                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" >
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$as->telepon}}</td>
                                            <td>{{$as->alamat}}</td>
                                            <td style="width: 10%"><a href="{{url('/data_peserta/'.$as->id)}}" onclick="return confirm('Data yang sudah dhapus tidak dapat dikembalikan!');" class="btn btn-danger btn-round btn-sm">Hapus</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
