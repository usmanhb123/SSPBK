...
<head>
  ...
  <title>{{$title}} @if($sub_menu)|| {{$sub_menu}} @endif - Sistem Seleksi Pegawai Berbasis Komputer</title>
    ...
    <div class="main-header">
      <!-- Logo Header -->
        ...
        <a href="#" class="logo">
          ...
          <b class="text-white">Labirin.Tech</b>
        </a>
        ...
        <h5 class="text-white mr-3 mt-3 text-right">{{date('l, d F Y')}} <br> {{$user->name}} </h5>
            <li class="nav-item dropdown hidden-caret">
              <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                <div class="avatar-sm">
                  <img src="{{asset('/img/profile_user/'. AUTH::user()->image)}}" alt="..." class="avatar-img rounded-circle">
                </div>
              </a>
              <ul class="dropdown-menu dropdown-user animated fadeIn">
                <div class="dropdown-user-scroll scrollbar-outer">
                  <li>
                    <div class="user-box">
                      <div class="avatar-lg"><img src="{{asset('/img/profile_user/'. AUTH::user()->image)}}" alt="image profile" class="avatar-img rounded"></div>
                      <div class="u-text">
                  ...
                  <a class="dropdown-item" href="{{url('user')}}"><i class="fas fa-user-tie mr-3"></i> My Profile</a>
                  <a class="dropdown-item" href="{{url('password')}}"><i class="fas fa-user-tag mr-3"></i> Change Password</a>
                  ...
                  <div class="form-group">
                    ...
                    <form action="{{url('user')}}/{{$user->id}}" method="POST">
                      ...
                      <div class="selectgroup selectgroup-secondary selectgroup-pills">
                        ...
                        <label class="selectgroup-item mt-2">
                          <input type="radio" name="mode" value="2" class="selectgroup-input" @if ($user->mode_gelap == 2)
                          checked=""
                          @endif onclick="submit()">
                          <span class="selectgroup-button selectgroup-button-icon"><i class="fa fa-sun"></i></span>
                        </label>
                        <label class="selectgroup-item mt-2">
                          <input type="radio" name="mode" value="1" class="selectgroup-input" onclick="submit()" @if ($user->mode_gelap == 1)
                          checked=""
                          @endif>
                    ...
                    <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="{{route('logout')}}" onclick="return confirm('Anda akan keluar dari aplikasi!, Yakin?')"><i class="icon-logout mr-3"></i>Logout</a>
                  </li>
                </div>
              </ul>
            </li>
